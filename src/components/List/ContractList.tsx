...
const ContractList: React.FC<{
    ...
    tabs?: JSX.Element;
}> = ({ title, filterComponent, children, tabs, footerButton }): JSX.Element => {
    return (
        <React.Fragment>
            ...
            {tabs}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-1 gap-4">{children}</div>
            {footerButton}
        </React.Fragment>
    );
};
