        ...
        return (
            <React.Fragment>
                {_.isEqual(filterType, "nft-sort") && (
                    <React.Fragment>
                        <div className="grid-row-2 absolute z-30 mt-[40px] ml-[-160px] grid hidden bg-floppy-disk md:inline">
        ...
        return (
            <React.Fragment>
                {_.isEqual(filterType, "nft") && (
                    <React.Fragment>
                        <div className="grid-row-2 absolute z-30 mt-[40px] ml-[-570px] grid hidden bg-floppy-disk md:inline">
