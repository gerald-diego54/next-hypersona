        ...
        return(
            <React.Fragment>
                { _.isEqual(filterType, "nft-sort") &&
                    <React.Fragment>
                        <div className="grid grid-row-2 mt-[40px] absolute ml-[100px] z-30 bg-floppy-disk hidden md:inline-block">
    ...
    const FilterNFT = ():JSX.Element => {
        return(
            <React.Fragment>
                ...
                <React.Fragment>
                    <div className="grid grid-row-2 mt-[40px] absolute z-30 ml-[-280px] bg-floppy-disk hidden md:inline-block">
